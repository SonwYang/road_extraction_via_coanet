...
def crop3(imgRoot, img_dir, targetSize, PaddingSize, ImgSuffix):
    labels_list = glob.glob(f"{imgRoot}/*")
...
if __name__ == '__main__':
    ...
    parse.add_argument("--dataRoot", type=str, default=r"D:\MyWorkSpace\dl_dataset\road_extraction\masa\test", help='the path of images output')
    parse.add_argument("--outRoot", type=str, default=r"D:\MyWorkSpace\dl_dataset\road_extraction\masa\test\crops", help='the path of labels output')
    parse.add_argument("--targetSize", type=int, default=512, help='the size of target')
    parse.add_argument("--PaddingSize", type=int, default=128, help='the size of padding')
    ...
    for root in rootList:
        ...
        subRoot = os.path.join(outRoot, fileName)
        gdalTools.mkdir(subRoot)
